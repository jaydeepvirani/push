...
public class RangeSeekBar<T extends Number> extends ImageView {
   ...
   * blue.
   */
  public static final int ACTIVE_COLOR = Color.parseColor("#00B69E");
  /**
  ...
  private static final int DEFAULT_TEXT_DISTANCE_TO_BUTTON_IN_DP = -40;
  private static final int DEFAULT_TEXT_DISTANCE_TO_TOP_IN_DP = 27;
  private static final int LINE_HEIGHT_IN_DP = 5;
  public static Integer DEFAULT_MINIMUM = 100;
  public static Integer DEFAULT_MAXIMUM = 1000;
  private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
  private final Paint shadowPaint = new Paint();
  int thumbShadow_Color;
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    if (attrs == null) {
      ...
      mDefaultColor = Color.parseColor("#1D1D26");
      mAlwaysActive = false;
      mShowTextAboveThumbs = true;
      mTextAboveThumbsColor = Color.parseColor("#1d1d26");
      ...
      try {
        ...
        mTextAboveThumbsColor =
            a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, Color.parseColor("#BA599C"));
        ...
        mInternalPad = a.getDimensionPixelSize(R.styleable.RangeSeekBar_internalPadding,
        ...
        mDefaultColor =
            a.getColor(R.styleable.RangeSeekBar_defaultColor, Color.parseColor("#1D1D26"));
        ...
        mThumbShadowBlur =
            a.getDimensionPixelSize(R.styleable.RangeSeekBar_thumbShadowBlur, defaultShadowBlur);
      } finally {
        a.recycle();
      }
    }
    ...
    if (mThumbShadow) {
      ...
      thumbShadow_Color = thumbShadowColor;
  ...
  public void setAlwaysActive(boolean mAlwaysActive) {
    this.mAlwaysActive = mAlwaysActive;
  }
  ...
  public void setInternalPadding(float internalPad) {
    mInternalPad = internalPad;
  }

  public void setThumbImage(Bitmap mThumbImage) {
    thumbImage = mThumbImage;
  }

  public void setThumbShadow(boolean isThumbShadow) {
    mThumbShadow = isThumbShadow;
  }

  public void setThumbShadowBlur(int thumbShadowBlur) {
    mThumbShadowBlur = thumbShadowBlur;
  }

  public void setThumbShadowYOffset(int yOffset) {
    mThumbShadowYOffset = yOffset;
  }

  public void setThumbShadowXOffset(int xOffset) {
    mThumbShadowXOffset = xOffset;
  }
  ...
  protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    int height = thumbImage.getHeight() + (!mShowTextAboveThumbs ? 0
        : PixelUtil.dpToPx(getContext(), HEIGHT_IN_DP)) + (mThumbShadow ? mThumbShadowYOffset
        + mThumbShadowBlur : 0);
  ...
  protected synchronized void onDraw(@NonNull Canvas canvas) {
    ...
    boolean selectedValuesAreDefault =
        (getSelectedMinValue().equals(getAbsoluteMinValue()) && getSelectedMaxValue().equals(
            getAbsoluteMaxValue()));

    int colorToUseForButtonsAndHighlightedLine =
        !mAlwaysActive && selectedValuesAreDefault ? mDefaultColor : // default values
    ...
    String minText =
        String.valueOf(getResources().getString(R.string.dollar) + getSelectedMinValue());
    String maxText =
        String.valueOf(getResources().getString(R.string.dollar) + getSelectedMaxValue());
